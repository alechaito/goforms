		...
		<nav class="col-md-2 d-none d-md-block bg-light sidebar">
			<div class="sidebar-sticky">
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						<a class="nav-link" href="#a" onclick="activaTab('a')" data-toggle="tab">
							Blocos e Questoes
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#d" onclick="activaTab('d')" data-toggle="tab">
							Abrir/Fechar
						</a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
						<a class="nav-link" href="#f" onclick="activaTab('f')" data-toggle="tab">
							Editar
						</a>
					</li>
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		...
		<div class="tab-content" id="tabs"> <!-- TAB CONTENT -->
					...
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">Permita com que este questionario seja respondido e feche-o assim que terminar a pesquisa.</p>
								@if($quiz->status == 0)
									<form method="POST" action="{{ route('quiz.changestatus.post') }}">
										@csrf
							...
							<div class="card-header">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										...
										<form id="update-up-{{$block->id}}" style="display: inline;" method="POST" action="{{ route('block.update.post') }}">
											@csrf
										...
										<form id="update-down-{{$block->id}}" style="display: inline;" method="POST" action="{{ route('block.update.post') }}">
											@csrf
											<input type="hidden" name="id_block" value="{{$block->id}}"/>
											<input type="hidden" name="id_quiz" value="{{$quiz->id}}"/>
										...
										<div class="btn-group" style="margin-left:10px;">
											...
											<div class="dropdown-menu dropdown-menu-lg-right">
												...
												<button id="{{$block->id}}" class="dropdown-item" type="button" data-toggle="modal" data-target="#modal-storequestion" onclick="display(this)">
			...
			<div class="tab-pane" id="f">
				<div class="row">
					<div class="col-md-6">
						<form method="POST" action="{{ route('quiz.update.post') }}">
							@csrf
							<label>Nome </label>
...
function display(data) {
    ...
    var table = $('#display-storequestions-include').DataTable( {
        "ajax": "/search-storequestion/block/"+data.id,
		"language": {
